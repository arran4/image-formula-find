...
func main() {
	...
	flag.StringVar(&outputPath, "output", "evolution-dna6.gif", "Path to output GIF")
	...
	// Using BasicRequired implementation from dna6
...
func drawDNABar(img *image.RGBA, r image.Rectangle, dna string) {
	...
	rStr, gStr, bStr := dna6.SplitString3(dna)
